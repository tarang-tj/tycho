...
Usage: python3 tools/build_terrain.py moon|mars|lunokhod|change4|opportunity|apollo17|all
...
addition (lunokhod, change4, opportunity, apollo17) is built by name
...
TARGETS = ("moon", "mars", "lunokhod", "change4", "opportunity", "apollo17", "all")
...
def main() -> None:
    ...
    if target == "opportunity":
        raise NotImplementedError(
            "opportunity is BLOCKED: no primary source for Opportunity's precise "
            "final-position coordinates was found this session (see reports/w1-d-data.md).")
    if target == "apollo17":
        process_apollo17()
