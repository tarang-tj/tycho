...
def write_body(body: str, elev_1024: np.ndarray, shade_1024: np.ndarray, slope_1024: np.ndarray,
               ...
               source: dict, license_text: str, credit: str, nodata_filled_fraction: float, notes: str) -> None:
    ...
    write_albedo_jpg(os.path.join(body_dir, "albedo.jpg"), elev_1024, shade_1024, slope_1024, mask_1024, body)
...
def main() -> None:
    if len(sys.argv) != 2 or sys.argv[1] not in ("moon", "mars", "all"):
        print(__doc__)
        sys.exit(1)
